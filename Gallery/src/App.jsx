...
function App() {
  ...
  const googleReviews = [
    ...
    },
    {
      reviewer: "Dyhanna N.",
      review:
        "David did an exceptional job refacing our cabinets. He is truly a master craftsman who made cabinet suggestions that have beautifully enhanced our kitchen in appearance , quality and functionality. We look foward to enjoying them for years to come !",
    },
    {
      reviewer: "Kathy R.",
      review:
        "Love my new cabinets. David from Atlantic Cabinet did a great job. He was professional, meticulous and responsive. I am very satisfied with the results.",
    },
    {
      reviewer: "Mary B.",
      review:
        "We are so delighted with our new cabinets! David was great to work with, he was professional , friendly and efficient. He covered the floor & counters so they wouldn’t be damaged and cleaned up after. It took just one day and we are so happy! Thanks David",
    },
    {
      reviewer: "Mary R.",
      review:
        "David was great to work with and delivered exactly what was promised. He was very precise and went out of his way to accommodate our wishes. Kitchen looks great! Highly recommend Atlantic Cabinet Refacing. Thank you, David!",
    },
    {
      reviewer: "Will D.",
      review:
        "We can't get over the transformation! New doors & drawer fronts, hardware and granite for a fraction of the cost (and time) of a complete remodel! Dave was a pleasure to work with. His knowledge of the business and attention to detail is top-notch. Can't recommend enough to all my friends!",
    },
    {
      reviewer: "Frank V.",
      review:
        "Cabinet fronts are well constructed and David takes great care to measure and install each for a better-than-new fit and finish. Could not be more pleased with the results.",
    },
    {
      reviewer: "Danielle G.",
      review:
        "David did an amazing job with our cabinets. He is top notch and extremely professional! HIGHLY recommend him!",
    },
    {
      reviewer: "Peg C.",
      review:
        "We couldn't be happier with the newly renovated kitchen. His ideas, capabilities, and suggestions were terrific. It looks exactly the way we wanted it to for a fraction of the cost a new kitchen would have been.",
    },
    {
      reviewer: "Sheila M.",
      review:
        "The cabinets look wonderful and are very high quality unlike some other refacing jobs that I've seen. I'm very happy with my new kitchen!",
    },
    {
      reviewer: "Sam C.",
    ...
    },
    {
      reviewer: "Dafna H.",
      review:
        "David was a pleasure to work with! Super professional, responsive and friendly. The end result is fantastic and it was a stress free process. I highly recommend working with David. I love my new kitchen!",
    },
  ];
  ...
  return (
    <>
      <div className="screen" id="topOfScreen">
        ...
        {view === 0 && (
          <>
            <button className="reviewButton" onClick={handleReviewClick}>
              Reviews
            </button>

            <div className="gallery">
              <h1>Over 90 Photos!</h1>
        ...
        {view === 1 && (
          <div className="reviews">
            <button className="galleryButton" onClick={handleGalleryClick}>
              Gallery
            </button>
